...
xpm_fifo_async_inst (
   ...
   .dout(read_data),                   // READ_DATA_WIDTH-bit output: Read Data: The output data bus is driven
   ...
   .din(i_w_data),                // WRITE_DATA_WIDTH-bit input: Write Data: The input data bus used when
                                  // writing the FIFO.
