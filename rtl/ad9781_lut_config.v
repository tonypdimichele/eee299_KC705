...
begin
	case(lut_index)			  
		...
		10'd  1 : lut_data <= {16'h0B00 , 8'hff}; //DAC1 FSC low byte  } {0Ch[1:0],0Bh} = 0x1FF of 0x3FF max
		10'd  2 : lut_data <= {16'h0C00 , 8'h03}; //DAC1 FSC high bits } = 50% full scale
		10'd  3 : lut_data <= {16'h0D00 , 8'h00}; //AUXDAC1
		10'd  4 : lut_data <= {16'h0E00 , 8'h00}; //AUXDAC1
		10'd  5 : lut_data <= {16'h0F00 , 8'hff}; //DAC2 FSC low byte  } {10h[1:0],0Fh} = 0x1FF of 0x3FF max
        10'd  6 : lut_data <= {16'h1000 , 8'h03}; //DAC2 FSC high bits } = 50% full scale
