...
begin
	case(lut_index)			  
		...
		10'd  1 : lut_data <= {16'h0B00 , 8'hff}; //DAC1 FSC made as low as possible to minimize swing
		10'd  2 : lut_data <= {16'h0C00 , 8'h03}; //DAC1 FSC
		10'd  3 : lut_data <= {16'h0D00 , 8'h00}; //AUXDAC1
		10'd  4 : lut_data <= {16'h0E00 , 8'h00}; //AUXDAC1
		10'd  5 : lut_data <= {16'h0F00 , 8'hff}; //DAC2 FSC same trying to minimize swing
        10'd  6 : lut_data <= {16'h1000 , 8'h03}; //DAC2 FSC
