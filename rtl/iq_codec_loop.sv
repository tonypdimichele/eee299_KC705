...
reg [15:0]  tone_pinc_dac1_ff1;
reg [15:0]  tone_pinc_dac1_ff2;
...
dds_compiler_0 dds_iq_core (
    ...
    .s_axis_phase_tdata(IQ_DDS_PINC),
...
always @(negedge i_dac1_clk) begin
    if (i_rst) begin
        ...
        tone_pinc_dac1_stable <= 16'd1311;
    end else begin
